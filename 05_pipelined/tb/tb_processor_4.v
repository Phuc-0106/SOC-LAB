...
module tb_processor_4;
  ...
  task run_checks;
    begin
      check_reg(1, 32'h00000400);
      check_reg(2, 32'h11223344);
      check_reg(3, 32'h00000044);
      check_reg(4, 32'h00000033);
      check_reg(5, 32'h00001122);
      check_reg(6, 32'h00003344);
    end
  endtask
  ...
  initial begin
    ...
    $display("============================================");
    $display("  tb_processor_4: CASE4 - Loads/Stores");
    $display("============================================");
    ...
    if (err == 0)
      ...
      $display("==== CASE4 FAIL, err = %0d ====", err);

    $finish;
  end

  initial begin
    $dumpfile("pipelined_processor_4.vcd");
    $dumpvars(0, tb_processor_4);
  end
