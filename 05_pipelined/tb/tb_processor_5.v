...
module tb_processor_5;
  ...
  task run_checks;
    begin
      ...
      check_reg(4, 32'h00000016);
      check_reg(5, 32'h00000400);
      check_reg(6, 32'h00000016);
      check_reg(7, 32'h00000022);
      check_reg(8, 32'h00000020);
    end
  endtask
  ...
  initial begin
    ...
    $display("============================================");
    $display("  tb_processor_5: CASE5 - Mixed ALU+Mem");
    $display("============================================");
    ...
    if (err == 0)
      ...
      $display("==== CASE5 FAIL, err = %0d ====", err);

    $finish;
  end

  initial begin
    $dumpfile("pipelined_processor_5.vcd");
    $dumpvars(0, tb_processor_5);
  end
