...
module tb_processor_3;
  ...
  initial begin
    ...
    $display("============================================");
    $display("  tb_processor_3: CASE3 - LUI/SLTI");
    $display("============================================");
    ...
    if (err == 0)
      ...
      $display("==== CASE3 FAIL, err = %0d ====", err);

    $finish;
  end

  initial begin
    $dumpfile("pipelined_processor_3.vcd");
    $dumpvars(0, tb_processor_3);
  end
